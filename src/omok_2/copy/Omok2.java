...
public class Omok2 extends JFrame {
	...
	private Image background = new ImageIcon(Main.class.getResource("intro_image.PNG"))
			.getImage();
	...
	public Omok2() {
		...
		exitButton.setBounds(300, 0, 30, 30);
		...
		startButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				background = new ImageIcon(Main.class.getResource("intro_image.PNG"))
						.getImage();
			}
		});
		add(startButton);
